      ...
      <main className="min-h-screen font-sans bg-logo-opaca text-gray-900 z-0">
        ...
        <section className="relative h-[50vh] flex items-center justify-center text-center px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto text-blue-600/90">
              Confiança e estratégia com presença global em consultoria
              financeira.
            </p>
          </motion.div>
        </section>
        ...
        <div className="max-w-6xl mx-auto px-6 py-16 space-y-20">
          ...
          <section className="grid md:grid-cols-2 gap-12 items-stretch">
            ...
            >
              <Card className="h-full hover:shadow-xl transition-shadow duration-300 border border-green-400/40 rounded-lg">
                ...
                <CardContent className="text-lg space-y-4 text-blue-900/90">
                  <p>
                    A <strong>Sunrad Partners – Wealth & Trade Finance</strong>{" "}
                    é uma consultoria financeira internacional com presença em
                    Lisboa, São Paulo, Miami e Bolonha.
                  </p>
                  <p>
                    Somos especialistas em soluções estratégicas para
                    empresários, gestores de patrimônio e investidores
                    institucionais, combinando visão global e atendimento local
            ...
            >
              <Card className="h-full hover:shadow-xl transition-shadow duration-300 border border-blue-400/40 rounded-lg">
                <CardHeader className="flex items-center gap-4">
                ...
                <CardContent className="text-lg space-y-4 text-blue-900/90">
                  <p>
                    Estruturamos soluções financeiras com excelência, promovendo
                    segurança, agilidade e resultados sustentáveis para cada
                    cliente.
                  </p>
                  <p>
                    Atuamos guiados por princípios inegociáveis de ética,
                    integridade e transparência.
                  </p>
                  <p>
                    Mais que serviços financeiros, entregamos visão estratégica
                    e confiança para decisões em um cenário global em
                    transformação.
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="relative max-w-3xl mx-auto space-y-12 pl-14">
              ...
              {[
                ...
                },
                {
                  ...
                  icon: (
                    <Globe2 className="w-6 h-6 text-green-500 opacity-80" />
                  ),
                },
                {
                  year: "2021",
          ...
          <section className="py-20 ">
            <h2 className="text-4xl font-extrabold mb-16 text-center text-blue-700 drop-shadow-md">
              Nossos Valores
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-10 max-w-5xl mx-auto text-center">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: i * 0.2 }}
                  className="p-8 rounded-xl bg-white/70 backdrop-blur-md shadow-lg border border-green-100"
                >
                  <div className="mb-4 flex justify-center items-center bg-green-50 rounded-full w-14 h-14 mx-auto shadow-sm">
                    {icon}
                  </div>
                  <h3 className="text-xl font-semibold mb-2 text-blue-900">
                    {title}
                  </h3>
                  <p className="text-blue-900/80 leading-relaxed">{desc}</p>
                </motion.div>
              ))}
            </div>
          </section>
