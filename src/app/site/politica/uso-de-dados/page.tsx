...
const blocos = [
    ...
    conteudo: (
      <>
        <ul className="list-disc pl-6 space-y-1">
          <li>
            {" "}
            <strong> Anonimização: </strong>Processo pelo qual um dado relativo
            ao titular não possa ser identificado, considerando a utilização de
            meios técnicos razoáveis e disponíveis na ocasião de seu tratamento.
            Colaboradores: São todos os empregados da SUNRAD,
          </li>
          <li>
            <strong> Colaboradores: </strong>São todos os empregados da SUNRAD,
            incluindo conselheiros e diretores.
          </li>
          <li>
            <strong> Dados pessoais: </strong>Qualquer informação relativa a uma
            pessoa singular identificada ou identificável. É considerada
            identificável uma pessoa singular que possa ser identificada, direta
            ou indiretamente, em especial por referência a um identificador,
          ...
          <li>
            <strong> Titular: </strong>Pessoa física a quem se referem os dados
            pessoais.
          </li>
          <li>
            <strong> Terceiros: </strong>São todos os prestadores de serviços,
            trabalhadores terceirizados, parceiros comerciais e fornecedores com
            quem a SUNRAD compartilha dados pessoais.
          </li>
        </ul>
      </>
    ),
      ...
      <>
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>
            ...
            transparência ao titular sobre o tratamento de seus dados pessoais.
          </li>
        </ul>
      </>
    ),
    ...
    conteudo: (
      <>
        <p className="mb-2">
          ...
          dados), deverão ser observadas as regras estabelecidas na Política de
          Compartilhamento de Dados Pessoais, na Política de Privacidade de
  ...
  },
  {
    ...
    conteudo: (
      <>
        <p className="mb-2">
          Os documentos que contenham dados pessoais não poderão ser armazenados
          por período superior ao necessário para o cumprimento da finalidade
          pretendida, independentemente do formato utilizado, seja físico ou
          eletrônico.
        </p>
      </>
    ),
    ...
    conteudo: (
      <>
        <p className="mb-2">
          ...
          hipóteses autorizadoras específicas para tanto. São considerados dados
          pessoais sensíveis aqueles relativos a:
        </p>
        <ul className="list-disc pl-6 space-y-1">
        ...
        <p className="mb-2">
          Em caso de dúvidas sobre a classificação de qualquer dado pessoal como
          sensível, o Encarregado de Dados deverá ser consultado.{" "}
        </p>
      </>
    ),
  },
  {
    ...
    conteudo: (
      <>
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>
            Em seu melhor interesse, ou seja, com a finalidade de beneficiá-las,
          ...
          <li>
            ...
            utilizando recursos audiovisuais, quando adequado, para proporcionar
  ...
  },
  {
    ...
    conteudo: (
      <>
        ...
        <p>
          Existência de lei, norma, decisão judicial ou regulação vigente, pela
          qual o tratamento se torna obrigatório (e não opcional). Exemplos:
        </p>
    ...
    conteudo: (
      <>
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>Arquivo de documentos para defesa em processos trabalhistas;</li>
          <li>
    ...
    conteudo: (
      <>
        <p className="mb-2">
          ...
          sanitária, sendo vedado qualquer outro uso que desvirtue essa
          finalidade. Exemplos:
        </p>
        <ul className="list-disc pl-6 space-y-1">
  ...
  },
  {
    ...
    conteudo: (
      <>
        <p className="mb-2">
          Para garantir a proteção da vida ou incolumidade física do titular ou
          de terceiros, quando em iminente perigo. Exemplo: atendimentos médicos
          de emergência.
        </p>
      </>
    ),
  },
  {
    ...
    conteudo: (
      <>
        ...
        <p className="mb-2">
          Essa base legal se encontra prevista exclusivamente para as hipóteses
    ...
    conteudo: (
      <>
        <p className="mb-2">
          ...
          agentes de tratamento, desde que o titular dos dados tenha expectativa
          quanto à atividade de tratamento. Exemplos:
        </p>
        <ul className="list-disc pl-6 space-y-1">
          <li>
        ...
        <p className="mb-2">
          ...
          direitos e liberdades fundamentais do titular. Quando o tratamento for
          realizado com base no legítimo interesse, o Encarregado de Dados
  ...
  },
  {
    ...
    conteudo: (
      <>
        <p className="mb-2">
          Pode ser utilizado para fundamentar qualquer atividade de tratamento,
          desde que seja livre, expresso, informado e inequívoco. Contudo, o
          tratamento realizado com base unicamente no consentimento fica
          restrito à vontade do titular, que pode, a qualquer tempo, revogá-lo.
          Nos casos em que a base legal adequada para o tratamento seja o
          consentimento, deverá ser observado a Política de Uso e Gestão do
          Consentimento.
        </p>
      </>
    ),
  },
  {
    ...
    conteudo: (
      <>
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>
            Analisar e aprovar ou reprovar as solicitações de suspensão de prazo
            de armazenamento de dados pessoais;
          </li>
          <li>
            Analisar situações em que os dados pessoais de crianças poderão ser
            manuseados sem o consentimento expresso de um dos pais ou
            responsável legal;
          </li>
          <li>
    ...
    conteudo: (
      <>
        <p className="mb-2">
          ...
          Colaboradores da SUNRAD, constituindo-se em violação a não observância
          aos preceitos nelas descritos, podendo acarretar na aplicação de
          medidas disciplinares, tais como advertência verbal, escrita ou até
          mesmo o desligamento por justa causa, dependendo da gravidade da falta
          cometida.
        </p>
      </>
    ),
  },
  {
    ...
    conteudo: (
      <>
        <p className="mb-2">
          A SUNRAD tem como uma de suas premissas a proteção dos dados pessoais
          de todas as pessoas envolvidas na sua cadeia de atividades. O direito
          à privacidade é uma prioridade e pauta todas as ações e políticas da
          SUNRAD. Dentre as atividades abrangidas por esta política, poderá
          ocorrer o Tratamento/Processamento de dados pessoais, ou seja,
          operações realizadas com dados pessoais, tais como a coleta, produção,
          utilização, acesso, distribuição, processamento, arquivamento,
          eliminação, entre outros. Desta forma, qualquer tratamento de dados
          realizado deverá respeitar as disposições gerais desta política, além
          dos demais documentos corporativos e políticas aplicáveis ao tema.
        </p>
      </>
    ),
  },
    ...
    conteudo: (
      <>
        <p className="mb-2">
          ...
          info@sunrad.pt. O cumprimento deste Procedimento é de suma importância
          e dever de todos. Em caso de não observância deste procedimento, favor
          reportar imediatamente ao Encarregado pela Proteção de Dados, pelo
          e-mail: info@sunrad.pt. As denúncias de violações às Políticas e
          Procedimentos serão anônimas e a não-retaliação será garantida.
        </p>
      </>
    ),
  },
...
export default function PoliticaUsoDeDados() {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="bg-card/40 p-6 md:p-8 rounded-xl shadow-lg backdrop-blur-md border border-border place-self-start">
            ...
            <p className="mb-4 text-foreground">
              A presente Política para Manuseio de Dados Pessoais (“Política”) tem como
              objetivo determinar as regras internas para o manuseio de dados pessoais.
            </p>
            <p className="text-foreground">
              Para os fins desta Política, entende-se por manuseio de dados pessoais:
              Toda operação de tratamento de dados pessoais, como, por exemplo, a coleta,
              ...
              avaliação ou controle da informação, modificação, atualização, comunicação,
          ...
          <div className="bg-card/40 p-6 md:p-8 rounded-xl shadow-lg backdrop-blur-md border border-border">
            {blocos.map(({ titulo, conteudo }) => (
              <div key={titulo} className="border-b border-border py-4">
                <button
                ...
                {abertos[titulo] && (
                  <p className="mt-2 text-foreground text-sm">{conteudo}</p>
                )}
              </div>
            ))}
          </div>
